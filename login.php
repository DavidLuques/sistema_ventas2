...
if($_POST){
  ...
  $entidadUsuario->obtenerPorUsuario($usuario); //a desarrollar
    ...
    echo $entidadUsuario->clave;
    echo "<br>".$clave."esta es la typeada";
if($entidadUsuario->verificarClave($clave , $entidadUsuario->clave)){
//el problema aqui es que no encrypta la password y i pienso que pass verify no funciona sin encriptar la de la db
	//if($clave == $entidadUsuario->clave){
    echo"hola";
